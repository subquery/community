...
**Пожалуйста, смотрите китайскую версию ниже**
...
> _"Использование SubQuery для запроса сетевых данных Darwinia стало очень простым и гибким. SubQuery рассматривает данные блокчейна как график, и использует расширяемость GraphQL для внедрения дополнительных функций. Мы считаем, что в будущем интерфейс данных в цепочке субстратов будет в основном использовать GraphQL, SubQuery делает это реальностью»_ — Darwinia
