...
У нас есть амбициозные цели в SubQuery, чтобы быть самым быстрым и доступным поставщиком услуг данных в Substrate. Мы написали эту белую бумагу, чтобы подчеркнуть наши [конкурентные преимущества](../blogs/20210616-SubQuery-Network-Our-Goals-and-Competitive-Advantages.md) и сейчас мы сосредоточились на выполнении этого видения. Сеть SubQuery работает вокруг двух ключевых аспектов, гибкости и простоты.
...
Проекты SubQuery теперь имеют возможность ускорить все это с помощью нашей новой функции — [SubQuery Dictionary](../blogs/20210630-SubQuery-Just-Got-a-lot-Faster-with-the-Dictionary.md). Мы, по сути, преиндексируем местоположение всех событий в цепочке, и в результате индексация увеличивается до 10 раз.
