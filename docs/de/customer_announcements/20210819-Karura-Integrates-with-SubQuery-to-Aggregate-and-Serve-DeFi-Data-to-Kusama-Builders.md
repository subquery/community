...
> *"Die Verwendung von SubQuery macht die Entwicklung von Apps einfach, da ich nicht mehr eine komplizierte Reihe von Aufrufen tätigen muss, um die benötigten Daten zu erhalten."* - Brett (Entwickler bei Acala)

Die Entwicklung von dApps auf Karura ist jetzt mit den neuen öffentlichen SubQuery-Projekten von Karura viel schneller. Es gibt ein öffentlich verfügbares [SubQuery-Projekt](https://explorer.subquery.network/subquery/AcalaNetwork/karura), das die Karura-Community forken und jede gewünschte dApp erstellen kann. Außerdem macht ein [Karura-Wörterbuch](https://explorer.subquery.network/subquery/AcalaNetwork/karura-dictionary) die [Indexierung viel schneller](../blogs/20210630-SubQuery-Just-Got-a-lot-Faster-with-the-Dictionary.md).
...
Karura bietet auch ein ethisches und nachhaltiges Token-Verteilungsmodell sowie ein Karura-Schatzamt in der Kette, die beide seine Gemeinschaft und Langlebigkeit unterstützen. Karura war die erste Parachain, die eine Parachain-Slot-Auktion auf Kusama gewann und einen Crowdloan von mehr als 500.000 KSM (100 Mio. USD) von ihrer Community einsammelte. Da Karura das neuartige Acala EVM nutzt, das Ethereum-Kompatibilität mit unbegrenzter Substrate\*-Funktionalität ermöglicht, ist das Netzwerk bestens gerüstet, um den Einsatz führender DeFi-Projekte zu unterstützen, die ihre Dienste über Ethereum hinaus erweitern wollen.

*[Substrate](http://substrate.dev/) *ist das Blockchain-Aufbaurahmenwerk für den Aufbau auf Polkadot und Kusama</0>
