...
Die Ankündigung der SubQuery Grants erfolgt nach dem Start der [The SubQuery Academy](./20211018-subquery-launches-the-subquery-academy.md) und _"The Hero Course"_, die darauf abzielt, Softwareentwickler im SubQuery-Ökosystem durch ein ansprechendes modulares Programm weiterzubilden und zu befähigen. Der Inhalt dieses Programms soll einen neuen Blockchain-Entwickler vom Anfang bis hin zu fortgeschrittenen Programmierkonzepten führen und ist [völlig kostenlos und über ein Online-Portal zugänglich](https://subquery.coassemble.com/unlock/dOKZW6O#/).
