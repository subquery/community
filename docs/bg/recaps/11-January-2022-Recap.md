...
[SubQuery си партнира с Gitcoin през декември](../blogs/20211120-gitcoin12-hackathon.md), за да спонсорира пет предизвикателства на стойност $37 000 (най-големият награден фонд в предизвикателството), като кани разработчиците да изградят полезни инструменти, табла за управление и дори да разширят SubQuery до друг слой-1 блокчейн.
...
[Прочетете повече за това как да използвате тези функции в нашите ъпдейтнати документи.](https://doc.subquery.network/query/aggregate/)

### SubQuery си партнира с Darwinia Network, за да изгради CLI инструмента на SubQuery

Darwinia си партнира с SubQuery, за да изгради множество приложения, които ще са необходими, за да осигурят най-доброто потребителско кросчейн изживяване. Това включва ново [Умно приложение, което е централен хъб](https://apps.darwinia.network/) за управление на всички взаимодействия в мрежата на Darwinia, включително управление, стейкване, проучване на веригата и други. Това приложение използва значително количество [SubQuery данни, за да покаже исторически данни и действия](https://explorer.subquery.network/subquery/darwinia-network/smart-app-crab). SubQuery ще работи в тясно сътрудничество с екипа на Darwinia, за да направи това най-доброто изживяване в цялата екосистема на Polkadot.

![](https://miro.medium.com/max/1200/1*bL2Csj9qyamD7txAheCTIg.gif)

Darwinia също работи в тясно сътрудничество с екипа на SubQuery за [изграждането на CLI инструмент](https://github.com/fewensa/subquery-cli) за управляваната от SubQuery услуга (https://project.subquery.network). Можете да използвате този [CLI](https://github.com/fewensa/subquery-cli), за да създадете проект на SubQuery и автоматично да внедрите нова версия или в началния, или в производствения слот. Освен това можете да извлечете информация, включително подробното състояние на синхронизиране и регистрационни файлове от вашия работещ проект, който се хоства безплатно в SubQuery Projects. [Read more here](../customer_announcements/20220125-subquery-partners-with-darwinia-network-to-build-subquerys-cli-tool.md)

## Мрежата на SubQuery

Последния разговор в общността разгледахме няколко важни подробности за предстоящата тестова мрежа на SubQuery. Тя ще се провежда през поне три сезона, всеки сезон ще тества различни аспекти на мрежата:
...
Всеки сезон ще има множество предизвикателства, които можете да изпълните, което може да доведе до истински SQT награди. Очаквайте нещата да започнат тук през март!

## Роудмап ъпдейт

Миналия октомври пуснахме [техническа пътна карта](https://blog.subquery.network/blogs/20211029-roadmap-october.html) със следващата година, начертана за SubQuery, ние сме закъсняли да разгледаме как точно се справяме тук.
