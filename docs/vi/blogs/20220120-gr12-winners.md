...
SubQuery, giải pháp lập chỉ mục dữ liệu hàng đầu trong Polkadot, rất vui mừng được giới thiệu những người chiến thắng của [cuộc thi Gitcoin GR 12 Hackathon gần đây](https://gitcoin.co/hackathon/gr12?org=subquery). Gitcoin được công nhận là một trong những cộng đồng nhà phát triển blockchain ưu việt, tập trung vào việc tạo cộng đồng và ứng dụng cho Web3. [SubQuery hợp tác với Gitcoin vào tháng 12](./20211120-gitcoin12-hackathon.md) để tài trợ cho năm thử thách với trị giá 37.000 USD (tổng giải thưởng lớn nhất trong thử thách), mời các nhà phát triển xây dựng các công cụ hữu ích, dashboards và thậm chí mở rộng SubQuery sang blockchain layer-1 khác.
