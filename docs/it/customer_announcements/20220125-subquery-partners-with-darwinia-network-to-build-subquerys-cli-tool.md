# SottoQuery partner con Darwin Network per costruire lo strumento CLI di SubQuery

![](https://miro.medium.com/max/1400/1*96OGWsQrxNGC5rblYxhdAw.jpeg)

Oggi vogliamo annunciare la partnership tra Solarbeam e SubQuery Network. Darwinia ha recentemente vinto il loro slot Kusama parachain aucton, e si sta preparando a garantire la loro slot Polkadot. As part of Darwinia’s roadmap to build a cross chain bridge hub for Polkadot, Darwinia has partnered with SubQuery to build the plethora of applications that will be needed to provide the ultimate user experience for cross chain interactions
