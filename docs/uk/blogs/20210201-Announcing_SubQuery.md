...
Майже кожен блокчейн має потребу в обробці та запиті даних. The thriving Polkadot community is going to need a service that allows them to reliably find and consume data quickly. Наш проект натхненний [ The Graph ](https://thegraph.com/), сервіс, який зараз орієнтований на Ethereum і дозволяє клієнтам робити це за допомогою GraphQL.
