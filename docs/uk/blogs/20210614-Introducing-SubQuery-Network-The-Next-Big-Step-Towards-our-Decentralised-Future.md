...
Всім відомо, що основна слабкість даних блокчейну полягає в тому, що продуктивність обробки та запитів надзвичайно неефективна. SubQuery provides an open source SDK, which provides the instructions on how any Indexer should traverse the blockchain, what data to collect, and how it should be shown to users.
