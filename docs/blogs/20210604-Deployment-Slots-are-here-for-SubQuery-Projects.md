...
[SubQuery Projects](https://managedservice.subquery.network/) is already being used as a managed and hosted service for many Projects, whether they’re chain explorers, wallets, NFT explorers, or others. It’s a service that our customers rely on.
...
You can try it yourself now in [SubQuery Projects](https://managedservice.subquery.network/).
