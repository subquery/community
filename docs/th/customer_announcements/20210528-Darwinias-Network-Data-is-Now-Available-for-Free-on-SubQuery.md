...
> การใช้งาน SubQuery เพื่อการ query ข้อมูลบนเครือข่าย Drawinia จะกลายเป็นเรื่องที่เรียบง่ายและยืดหยุ่น SubQuery ถือว่าข้อมูลเป็นกราฟ และใช้ประโยชน์จากความสามารถในการขยายของ GraphQL เพื่อแนะนำฟังก์ชันเพิ่มเติม พวกเราเชื่อว่าในอนาคต อินเตอร์เฟซของข้อมูลบน substrate chain จะใช้ GraphQL เป็นหลัก ซึ่ง SubQuery กำลังให้สิ่งนี้เกิดขึ้นจริงในอนาคต
