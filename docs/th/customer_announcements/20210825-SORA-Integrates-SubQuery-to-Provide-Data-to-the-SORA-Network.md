...
> _"SubQuery ได้รับเลือกเพื่อปรับปรุง UX ของการใช้เครือข่าย SORA We used SubQuery to get and list extrinsic details, calculate fiat prices and liquidity pool APY. Our goal was to get transaction history and aggregated data for applications that work with the SORA network._
> 
