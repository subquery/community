...
また、Karuraは、倫理的で持続可能なトークンの流通モデルと、オンチェーンのKarura Treasuryを提供しており、この2つがコミュニティと長寿を支えています。 Karuraは、Kusamaのパラチェーンスロットオークションで勝利した最初のパラチェーンであり、コミュニティから500,000KSM(1億ドル) 以上のクラウドローンを集めました。 Because Karura leverages the novel Acala EVM, which enables Ethereum compatibility with unlimited Substrate\* functionality, the network is primed to support the deployment of leading DeFi projects who aim to expand their services beyond Ethereum.
