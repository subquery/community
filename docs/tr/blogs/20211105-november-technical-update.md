...
Geçen hafta [Moonriver'a eksiksiz EVM ve Substrate indeksleme desteği getirmek için Moonbeam ile çalıştığımızı](../customer_announcements/20211028-moonbeam-evm.md) duyurmaktan memnuniyet duyduk.
...
[Öncelikle, Moonbeam, Moonbase Alpha ve Moonriver'a nasıl bağlanılacağına ve bu verilerden nasıl indeksleneceğine ilişkin güncellenmiş belgeler hakkında bilgi edinin.](https://doc.subquery.network/create/substrate-evm/) Moonbeam verilerini indeksleme işlemi sadece iki adımdan oluşur:

### 1. Adım: Moonbeam Özel Veri Kaynağını Ekleyin

Moonbeam'in [Frontier](https://github.com/paritytech/frontier) uygulamasıyla çalışmak için özel olarak yapılmış bir veri işlemcisi oluşturduk. Argümanları ayrıştırmak için işlemci tarafından kullanılan belirli ABI kaynaklarına ve olayların geldiği veya çağrının yapıldığı akıllı sözleşme adresine başvurmanıza olanak tanır. [Daha fazlasını buradan okuyabilirsiniz.](https://doc.subquery.network/create/substrate-evm/#data-source-spec).
...
Bununla ilgili herhangi bir sorunuz varsa, [belgelerimizi kontrol ettiğinizden](https://doc.subquery.network/create/substrate-evm) emin olun veya [Discord topluluğumuzdaki](https://discord.com/invite/subquery) #technical-destek kanalımızdan bize ulaşın.
